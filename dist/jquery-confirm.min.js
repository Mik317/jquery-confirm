...
if(this.closeIcon){if(this.closeIconClass){this.closeIconClass=this.closeIconClass.replace('"','');var closeHtml='<i class="'+this.closeIconClass+'"></i>';this.$closeIcon.html(closeHtml)}
...
return;this.icon=this.icon.replace('"','');this.$icon.html(this.icon?'<i class="'+this.icon+'"></i>':'');this.updateTitleContainer()},updateTitleContainer:function(){if(!this.title&&!this.icon){this.$titleContainer.hide()}else{this.$titleContainer.show()}},setContentPrepend:function(content,force){if(!content)
